...
class FrmMain ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"GTM Link Sender", pos = wx.DefaultPosition, size = wx.Size( -1,265 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		gbSizer3.Add( self.m_staticText8, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.btnOpenGTM = wx.Button( self, wx.ID_ANY, u"Open GTM", wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer3.Add( self.btnOpenGTM, wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5 )
		...
		# Connect Events
		self.btnOpenGTM.Bind( wx.EVT_BUTTON, self.btnOpenGTMClick )
	...
	def btnOpenGTMClick( self, event ):
		event.Skip()
